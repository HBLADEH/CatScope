...
该脚本会执行 Go 测试、前端构建、`wails build -platform darwin/universal -clean -skipbindings`，生成 `dist/CatScope-v0.6.3-preview-macos-universal.dmg`，并写入 `dist/CatScope-v0.6.3-preview-macos-universal.dmg.sha256`。
