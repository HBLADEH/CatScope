...
CatScope 当前处于 MVP 阶段。核心 Logcat Viewer、Offline Log File Viewer、规则化 Crash / ANR / Native / JNI / Install Error Analyzer、本地 AI Context Generator、最小 Build / Install / Launch 工作流、轻量 Workspace / Filter Presets，以及 Session 保存与恢复已可用。
